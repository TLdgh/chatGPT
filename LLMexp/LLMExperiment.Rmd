...
```{r}
plot_ly(countdata, x=~Primary_Cat, y=~CountAuth, color = ~Model, type = 'scatter', mode="markers")
```


```{r}
qqnorm(fit1$residuals, datax = FALSE)
qqline(fit1$residuals, datax = FALSE, lwd=3)
```
